      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 grid lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-12">
            ...
            <div className="space-y-8">
               <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">123 Innovation Drive, Tech District,<br />Dakar, Senegal, BP 45000</p>
                  </div>
               </div>
               ...
               <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">+221 33 000 00 00<br />Mon - Fri, 9am - 6pm</p>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="h-64 bg-gray-200 rounded-3xl overflow-hidden shadow-inner grayscale hover:grayscale-0 transition-all">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3858.988015386001!2d-17.47271882417737!3d14.713203474327092!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xec1725459345c27%3A0x8673327d4c20f171!2sDakar!5e0!3m2!1sen!2ssn!4v1700000000000!5m2!1sen!2ssn" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              loading="lazy"
